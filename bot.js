...
const CONFIG = {
  ...
  WEBHOOK_URL:    process.env.WEBHOOK_URL,     // e.g. https://your-railway-domain.railway.app
...
// ── BOT INITIALISATION (Webhook mode — no polling conflict) ───────────────────
let bot;
if (CONFIG.WEBHOOK_URL) {
  ...
  console.log('Running in polling mode (set WEBHOOK_URL for webhook mode)');
}
